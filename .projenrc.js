const { AwsCdkConstructLibrary, NodePackageManager, ProjectType } = require('projen');
...
const project = new AwsCdkConstructLibrary({
  ...
  peerDeps: ['@seeebiii/ses-verify-identities@3.0.1'], /* Peer dependencies for this module. */
